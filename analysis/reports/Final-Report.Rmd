...
plot <- ggplot(lie_counts, aes(x = QuestionType, y = perc, fill = Response)) +
  ...
  labs(#title = "QQ3 Responses Before vs. After Ad (By Gender: Male and Female Only)",
       ...
       y = "Percentage\n",
       fill = "Theme of Written Response") +  # Legend title
...
ggsave("images/gender_responses_Q3.png", width = 8, height = 5, dpi = 300)
...
The original R markdown file and code for this report, plus relevant data and files are located [*https://github.com/kbeaver1/misinformation_quality_study*](https://github.com/kbeaver1/misinformation_quality_study)*,* which the people involved in this study only have access to.
